\chapter{Matematično izražanje}\label{POGLAVJE: Matematično izražanje}
	...
	\section{Simbolni zapis}\label{RAZDELEK: Simbolni zapis}
		...
		Predikate lahko \df{kvantificiramo} po njihovih spremenljivkah, tj.~povemo, \qt{kako pogosto} velja lastnost, dana s predikatom. Tabela~\ref{TABELA: kvantifikatorji} podaja najpogosteje uporabljane kvantifikatorje in njihove oznake.
