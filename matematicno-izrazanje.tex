\chapter{Matematično izražanje}\label{POGLAVJE: Matematično izražanje}
	...
	\section{Definicije}
		...
		\note{Predlagam, da v definicijah konsistentno uporabljamo `kadar' namesto `če' (\qt{Funkcija je zvezna, kadar velja to in to.}). V definicijah gre za ekvivalenco, ne implikacijo. --Davorin}