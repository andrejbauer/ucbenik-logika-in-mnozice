...
\davorin{Mogoče dodamo še mrežno strukturo množice $\NN$, tj.~$\min$ in $\max$? Verjetno bomo že pri mrežah (v poglavju o strukturah) povedali, da je vsaka linearna urejenost mreža.}

\note{monotonost operacij}
...
Kako to doseči? Za vsak par naravnih števil $a, b \in \NN$ želimo imeti element, ki predstavlja njuno razliko. Pretkana ideja, kako to doseči, je: razliko teh elementov predstavimo kar z elementoma samima, tj.~njuno razliko naj predstavlja par $(a, b)$.
...
Ker v tem kontekstu par $(a, b)$ predstavlja razliko števil $a$ in $b$, ga imenujemo \df{formalna razlika} teh dveh elementov. Cela števila smo definirali kot množico formalnih razlik naravnih števil, pri čemer smo poistovetili tiste razlike, ki morajo imeti isto vrednost. Elementi množice $\ZZ$ so torej ekvivalenčni razredi $\ec[\approx]{(a, b)}$, ki jih bomo pa zavoljo lažje berljivosti pisali kar kot $\ec{a, b}$.

Množico naravnih števil lahko obravnavamo kot podmnožico množice celih števil v smislu, da imamo vložitev $\NN \to \ZZ$, dano s predpisom $n \mapsto \ec{n, 0}$ (ideja je, da vsako naravno število $n \in \NN$ predstavimo kot razliko $n - 0$). \davorin{Koliko podrobneje bomo to razjasnili, je odvisno od tega, kaj bomo že predtem povedali o podmnožicah oziroma vložitvah.} Trdimo, da je ta preslikava res injektivna. Vzemimo poljubna $m, n \in \NN$, za katera velja $\ec{m, 0} = \ec{n, 0}$. To pomeni $(m, 0) \approx (n, 0)$, torej $m + 0 = 0 + n$ oziroma $m = n$.

Podoben razmislek nam pove, da relacija $\leq$ na $\ZZ$ razširja relacijo $\leq$ na $\NN$. Namreč, za poljubna $m, n \in \NN$ velja
