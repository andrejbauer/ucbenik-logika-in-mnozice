...
\note{karakterizacija: začetni polkolobar z enico}

\note{karakterizacija: objekt naravnih števil v kategoričnem smislu}

\note{karakterizacija: začetna algebra za funktor $X \mapsto X + 1$} \davorin{če se bo to dalo povedati brez, da bi pregloboko zašli v teorijo kategorij}
