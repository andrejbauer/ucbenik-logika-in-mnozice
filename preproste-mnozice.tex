...
\begin{pravilo}[Eksponentna množica]
  Za vsaki množici $A$ in $B$ ima \df{eksponentna množica $B^A$} za elemente natanko vse
  preslikave iz~$A$ v~$B$.
\end{pravilo}
...
da je funkcija podana z domeno, kodomeno ter celovitim in enoličnim prirejanjem med njima.
Pravilo uporabe je kar uporaba funkcije na argumentu: če je $f \in B^A$ in $a \in A$,
lahko tvorimo $f(a) \in B$. Tudi računsko pravilo za preslikave smo že spoznali, saj je to
kar pravilo zamenjave: funkcijski predpis uporabimo na argumentu tako, da vezano
spremenljivko v predpisu zamenjamo z argumentom. Ekstenzionalnost preslikav pove, kdaj sta
dve preslikavi enaki.
