...
Izmed vseh zakonov, ki so zapisani v izreku, dokažimo nenavadne in poučne, ostale pa
pustimo za vajo.

Za ogrevanje dokažimo asociativnost zmnožkov,
$A \times (B \times C) \ism (A \times B) \times C$. Splošni element
$A \times (B \times C)$ urejeni par oblike $(x, (y, z))$, kjer je $x \in A$, $y \in B$ in
$z \in C$, med tem ko je splošni element $(A \times B) \times C$ oblike $((u, v), w)$,
...
\begin{naloga}
  Preveri še preostale zakone iz izreka~\ref{izrek:algebra-mnozic}.
\end{naloga}
