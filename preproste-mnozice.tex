...
\begin{naloga}
  Ugotovite, katerih zakonov iz izreka~\ref{izrek:algebra-mnozic} v tem razdelku ne bomo
  utemeljili in to storite sami.
\end{naloga}
...
\subsection{Preslikave in prazna množica}
...
\begin{naloga}
  Preveri tiste zakone iz izreka~\ref{izrek:algebra-mnozic}, ki jih še nismo dokazali.
\end{naloga}
