...
Osrednji gradniki sodobne matematike so \df{množice}, ki so skupki ali zbirke matematičnih
...
zelo uporabne v vsej matematiki, jih niso hoteli kar zavreči, po drugi strani pa je bilo
treba preprečiti Russellov in druge paradokse, ki so jih še odkrili. Bertrand Russell je
predlagal rešitev, ki jo je poimenoval \df{teorija tipov}. Tako kot množice so bili tipi
skupki elementov, a so tvorili neskončno hierarhijo, ki je preprečevala obstoj tipa vseh
tipov, ki ne vsebujejo samega sebe. Russellova teorija tipov je pomembno vplivala na
...
množic in \df{razredov}. Množice smejo biti elementi množic in razredov, razredi pa ne.
