...
$2 \sin(x + \pi/4)$. Take predpise zapišemo tudi s pušico $\mapsto$,
%
\begin{equation*}
  x \mapsto 2 \sin(x + \pi/4).
\end{equation*}
%
Matematiki smo natančni, zato ne mešamo uporabe puščic $\to$ in $\mapsto$. Računalničarjem
beseda `predpis' pomeni program, zato o funkcijah razmišljajo kar kot o programih---tudi
to je eden od možnih pogledov na funkcije. V teoriji množic razumemo besedo `predpis' v
najbolj splošnem pomenu.
