...
\begin{pravilo}[Ekstenzionalnost preslikav]
  Preslikavi sta enaki, če imata enaki domeni in kodomeni in če imata za vse argumente
  enaki vrednosti.
\end{pravilo}
...
da tega ne bi eksplicitno zapisali. Vsak matematik vam pove povedati kako zgodbo o tem,
...
tem poglavju bomo spoznali tri osnovne konstrukcije, kasneje, ko bomo že nekaj vedeli o
logiki, pa še ostale. Najprej obravnavajmo kartezični produkt ali zmnožek množic.

Takoj se zastavi vprašanje, kako sploh opisti novo konstrukcijo množic. Ker že vemo, da je
po načelu ekstenzionalnosti

\begin{pravilo}
  \label{pravilo:kartezicni-produkt}
  Za vsaki množici $A$ in $B$ je \df{kartezični produkt} ali \df{zmnožek} množic $A$ in $B$ množica $A \times B$
\end{pravilo}
