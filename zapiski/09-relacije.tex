...
množicah, $R \subseteq A \times B$ -- rečemo tudi, da je $R$ relacije med~$A$ in~$B$.
...
\begin{dokaz}
  ...
  %
  \begin{align*}
    x (\diag[B] \circ R) z &\iff \\
    \some{y \in B} x \rel{R} y \land y \diag[B] z  &\iff \\
    \some{y \in B} x \rel{R} y \land y = z &\iff \\
    x \rel{R} z
  \end{align*}
  %
