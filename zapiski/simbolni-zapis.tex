...
\nls{iz $\phi$ sledi $\psi$ in nato iz $\psi$ sledi $\rho$ in nato iz $\rho$ sledi $\sigma$}.
...
%
V razdelku~\ref{sec:enolicni-obstoj} bomo spoznali, kako se zapiše \nls{obstaja natanko} en s pomočjo~$\exists$ in~$\forall$.
...
%
\begin{quote}
  \nls{Število $4$ ima največ en realen kvadratni koren.}
\end{quote}
%
pa tudi
%
