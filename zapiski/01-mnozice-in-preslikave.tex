...
običajnega razumevanja besede `množica'. Mi bomo spoznali standardno inačico teorijo množic,
...
matematičnimi objekti določajo izključno dogovorjeni matematični zakoni in ne vsakdanja raba in pomen besed, s
katerimi se nanje sklicujemo.
%
...
Iz zagate so se matematiki rešili s previdno izbranimi pravili, ki določajo dopustne \df{konstrukcije množic}.
...
\end{enumerate}
%
Tako nam prva trditev zagotavlja $1+1 \in \set{1, 2, 3}$, ker velja
...
bilo mišljeno, ker imamo ljudje zelo podobne sposobnosti prepoznavanja vzorcev. Z
matematičnega vidika pa to ni dopustno, saj lahko tropičje \emph{vedno} razumemo na več
načinov.\footnote{Ne verjamete? Naslednji člen v zaporedju $1, 2, 3, \ldots$ je seveda~$5$, ker je
...
slovenščine prečrtala z rdečo. Iz nesrečnega tropičja se res ne vidi, kaj je in kaj ni dovoljeno. Če poškilite
v poglavje~\ref{cha:aksiomi-teorije-mnozic}, kjer so našteti aksiomih Zermelo-Fraenkelove teorije
množic, pravila o končnih množicah ne boste našli.
...
\begin{dokaz}
  ...
  $\set{2, 1, 1}$, kar pomeni, da moramo preveriti, ali imata enake elemente. To
...
Nesrečno tropičje v pravilu~\ref{pravilo:koncna-mnozica} povzroča dovolj dvomom, da bi ga bilo dobro odpraviti.
...
Priročno je imeti v roki neko množico z enim elementom, pri čemer je vseeno, kateri element vsebuje. V ta namen postavimo pravilo, ki zagotavlja obstoj množice z enim elementom.
