...
\end{align*}
%
To se še vedno le tabele, predstavljene na drugačen način. Pomembno je, da je domena~$f$ končna množica.
...
\begin{zgled}
  ...
  \end{align*}
  %
  Pravilo preberemo takole: \nls{če je $x < 0$, mu priredimo vrednost $-x$, in če je $x \geq 0$, mu priredimo vrednost~$x$}.
\end{zgled}
...
\begin{zgled}
  ...
  \end{align*}
  %
  Pravilo preberemo takole: \nls{če je $x < 0$, mu priredimo vrednost~$-1$, če je $x = 0$, mu priredimo vrednost~$0$, in če je $x > 0$, mu priredimo vrednost~$1$}.
\end{zgled}
