\chapter{Relacije}\label{poglavje:relacije}
        ...
        \section{Splošno o relacijah}
                ...
                \begin{definicija}
                        ...
                        \begin{itemize}
                                ...
                                \item
                                        \df{območje definiranosti} ali \df{nosilec} relacije $\rel$ je množica $\dd{\rel} \dfeq \set{x \in X}{\some{y \in Y} \rel[x][y]}$ (torej $\dd{\rel} \subseteq \dom(\rel)$),
                                \item
                                        \df{zaloga vrednosti} ali \df{slika} \note{razpon?} relacije $\rel$ je množica $\rn{\rel} \dfeq \set{y \in Y}{\some{x \in X} \rel[x][y]}$ (torej $\dd{\rel} \subseteq \cod(\rel)$).
                        \end{itemize}
                \end{definicija}
        ...
        \section{Lastnosti relacij}\label{razdelek:lastnosti-relacij}
                ...
                \begin{trditev}\label{trditev:obstoj-ogrinjace-iz-presecne-dednosti}
        ...
        \section{Izpeljava preslikav iz relacij}\label{razdelek:izpeljava-preslikav-iz-relacij}
                ...
                Kot dvomestna relacija ima vsaka delna preslikava določeno domeno, kodomeno, nosilec in zalogo vrednosti. Če je $f$ delna preslikava z domeno $X$ in kodomeno $Y$, to zapišemo kot $f\colon X \parto Y$.
                ...
                \begin{zgled}
                        Deljenje na realnih številih lahko obravnavamo kot delno preslikavo $/\colon \RR \times \RR \parto \RR$; njen nosilec je $\dd{/} = \RR \times \RR_{\neq 0}$. Za vsak $x \in \RR$ velja $\frac{x}{x^2} \kleq \frac{1}{x}$, ne pa tudi $\frac{x^2}{x} \kleq x$ (premisli, zakaj).
                \end{zgled}
        ...
        \section{Ekvivalenčne relacije in kvocientne množice}
                ...
                Ena temeljnih matematičnih dejavnosti je \df{abstrakcija} \davorin{pojmovanje?}, tj.~iz posamičnih primerov izluščimo njihovo temeljno, bistveno lastnost in potem delamo s to lastnostjo. \davorin{To je pomembna stvar. Dajmo to razlago čimbolj izboljšati.} Na primer, vemo, kaj pomeni ``pet rac'', ``pet avtov'', ``pet sekund'', ampak kaj pomeni ``pet''?
                ...
                \davorin{Razdelitev množice bomo verjetno definirali že prej, najbrž pri vsotah množic. Če ne, potem na tem mestu pride še definicija razdelitve.}

                \begin{izrek}[ekvivalenčne relacije natanko ustrezajo razdelitvam]
                ...
                \begin{proof}
                        \begin{enumerate}
                                \item
                                        \begin{implproof}{\text{\textit{a}}}{\text{\textit{b}}}
                                        \end{implproof}
                                        \begin{implproof}{\text{\textit{b}}}{\text{\textit{a}}}
                                        \end{implproof}
                                \item
                        \end{enumerate}
                        \note{dokončaj dokaz}
                ...
                Vzemimo na primer eksponentno funkcijo $\lam{x} e^x$. Če jo obravnavamo kot preslikavo $\RR \to \RR$, seveda nima obrata, saj ni surjektivna. Ideja je, da zožimo kodomeno do zaloge vrednosti --- preslikava $(\lam{x} e^x) : \RR \to \RR_{> 0}$ je bijektivna in posledično lahko definiramo njen obrat (naravni logaritem) $\ln : \RR_{> 0} \to \RR$.
