...
\newcommand{\sqt}[1]{{\quotesinglbase}{#1}{‘}}  % text in single quotation marks
\newcommand{\qt}[1]{{\quotedblbase}{#1}{‘‘}}  % text in double quotation marks
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\NewDocumentCommand{\lpr}
{O{\empty} O{\empty}}
{\pi_{{#1}\ifthenelse{\equal{#2}{}}{}{,}{#2}}}
\NewDocumentCommand{\rpr}
{O{\empty} O{\empty}}
{\rho_{{#1}\ifthenelse{\equal{#2}{}}{}{,}{#2}}}
\NewDocumentCommand{\lin}
{O{\empty} O{\empty}}
{\iota_{{#1}\ifthenelse{\equal{#2}{}}{}{,}{#2}}}
\NewDocumentCommand{\rin}
{O{\empty} O{\empty}}
{\kappa_{{#1}\ifthenelse{\equal{#2}{}}{}{,}{#2}}}
...
\newcommand{\suc}[1][]{s\ifthenelse{\equal{#1}{}}{}{({#1})}}  % successor
